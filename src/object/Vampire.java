...
public class Vampire extends Player {
	...
	public Vampire(int x, int y) {
		super("../Vampire/idle 1.png");
		super.setCharacter("Vampire");
		super.setIcon("../Vampire/Vampire Portrait.png");
	...
	public Attack specialAttack() {
		...
		if (super.getDirection().equals("right")) {
			a = new RedBat("../Vampire/red bat.jpg", super.getX() + (super.getWidth() / 2) - 50, super.getY(), 100,
					100, this, super.getDirection(), 15);
			a.setVx(50);
			super.setVx(0);
